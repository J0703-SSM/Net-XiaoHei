    ...
    <body>
        ...
        <div id="navi">                        
            <ul id="menu">
                ...
                <li><a href="/role/adminList" class="role_off"></a></li>
                ...
                <div id="data">            
                    <table id="datalist">
                        ...
                        <tr>
                            ...
                            <td>${admin.adminInfo.id}</td>
                            <td>${admin.adminInfo.name}</td>
                            <td>${admin.adminInfo.admin_code}</td>
                            <td>${admin.adminInfo.telephone}</td>
                            <td>${admin.adminInfo.email}</td>
                            <td>${admin.adminInfo.enrollDate}</td>
                            <td>
                                <a class="summary"  onmouseover="showDetail(true,this);" onmouseout="showDetail(false,this);">${admin.adminForRoles[0].roleName}...</a>
                                <!--浮动的详细信息-->
                                <div class="detail_info">
                                    <c:forEach items="${admin.adminForRoles}" var="roles" varStatus="s">
