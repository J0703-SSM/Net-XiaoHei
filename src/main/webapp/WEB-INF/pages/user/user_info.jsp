...
<div id="main">
    ...
    <form action="" method="" class="main_form">
        ...
        <div class="input_info"><input type="text" readonly="readonly" class="readonly"
                                       value="${user.adminInfo.admin_code}"/></div>
        <div class="text_info clearfix"><span>角色：</span></div>
        <div class="input_info">
            <input type="text" readonly="readonly" class="readonly width400"
                   value="<c:forEach items="${user.adminForRoles}" var="role" varStatus="s"><c:if test="${!s.first}"> , </c:if>${role.roleName}</c:forEach>"/>
        </div>
        ...
        <div class="input_info"><input type="text" readonly="readonly" class="readonly"
                                       value="${user.adminInfo.enrollDate}"/></div>
        <input type="hidden" id="emailPass">
...
<script>
    ...
    $("#email").blur(function () {
        ...
        if (emailPass()) {
            ...
            $.post("/userInfo/sameEmail", {email: $("#email").val()}, function (result) {
                ...
                if (result.resultCode == 1) {
                    ...
                    $("#emailMsg").html("<span class='error_msg'>" + emailCompany[0] + "邮箱已被注册</span>")
